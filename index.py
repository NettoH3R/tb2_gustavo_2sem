...
marcas = ["Samsung", "Motorola", "Apple", "Xiaomi", "Realme"]
precos = [3500, 2000, 6000, 1800, 1500, 3800, 2800, 2500, 7000, 1200]
avaliacoes = [4.5, 4.0, 4.8, 4.2, 3.9, 4.6, 4.3, 4.1, 4.9, 3.7]

# Quantidade de vendas simulada para treinar o modelo
vendas = [500, 300, 1000, 450, 350, 600, 700, 650, 1100, 250]
